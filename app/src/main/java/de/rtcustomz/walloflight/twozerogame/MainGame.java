...
public class MainGame {
    ...
    private static final long MOVE_ANIMATION_TIME = TwoZeroView.BASE_ANIMATION_TIME;
    private static final long SPAWN_ANIMATION_TIME = TwoZeroView.BASE_ANIMATION_TIME;
    private static final long NOTIFICATION_DELAY_TIME = MOVE_ANIMATION_TIME + SPAWN_ANIMATION_TIME;
    private static final long NOTIFICATION_ANIMATION_TIME = TwoZeroView.BASE_ANIMATION_TIME * 5;
    ...
    private final TwoZeroView mView;
    ...
    public MainGame(Context context, TwoZeroView view) {
        mContext = context;
        mView = view;
